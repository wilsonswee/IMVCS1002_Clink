...
async function main() {
    try {
        ...
        // when not on localhost, set this set asLocalhost: false
        //const connectionOptions: any = { wallet, identity: 'Org2 MSP Admin', discovery: { enabled: true, asLocalhost: false } };
...
void main();
//# sourceMappingURL=querylocal.js.map